 ...
 * 
 */
public class NoEnergy extends DecoratorCheckRule {
	...
	/**
	 * Creates a new NoEnergy instance, which checks only the restrictions defined on itself.
	 */
	public NoEnergy(){
		super();
	}
	/**
	 * Creates a new NoEnergy instance, which wraps cr as stated
	...
	protected boolean checkSpecificPart(IRule r) {
		...
		return !(r instanceof IEnergyRule);
	...
	protected String getSpecificCause() {
		...
		return "Rules with associated energy are not allowed";
	}
