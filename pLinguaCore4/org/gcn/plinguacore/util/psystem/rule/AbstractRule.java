...
public abstract class AbstractRule implements Serializable,IRule {
	...
	protected final static void replaceMultiSet(MultiSet<String> membraneMultiSet, Object find,
	...
	public boolean execute(ChangeableMembrane membrane,
		 ...
		 */
		//System.out.println("AbstractRule : isString = " + isString());

		if(isString()){
			return executeSafeString(membrane, environment, executions);
		}

		//System.out.println("leftHandRule " + leftHandRule.toString() + " rightHandRule " + rightHandRule.toString());
		//System.out.println("leftHandRule multiset " + leftHandRule.getMultiSet().toString() + " rightHandRule multiset " + rightHandRule.getMultiSet().toString());
	...
	public boolean isString(){
		...
		if(leftHandRule.toString().contains("<") && rightHandRule.toString().contains("<")){
			return true;
		}
		return false;
	}
