...
public final class TransitionSimulator extends CellLikeSimulator {
	...
	public TransitionSimulator(Psystem psystem) {
		...
		System.out.println("Transition Simulator Constructor");

	}

	@Override
	protected void microStepSelectRules(ChangeableMembrane m,ChangeableMembrane temp) {
		System.out.println("Transition Simulator : microStepSelectRules");
		...
		while (it.hasNext()) {
			...
			System.out.println("TRANSITION SIMULATOR: count = " + count);
			if (count > 0) {
