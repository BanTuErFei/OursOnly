...
public class EvolutionCommunicationPsystemFactory extends
	...
	protected ECPesystemFactory() {
		super();
		// TODO Auto-generated constructor stub

		checkRule = new Constant(new NoCharges(new NoEmptyLeftMultiSet(
	...
	public static ECPesystemFactory getInstance()
	{
		if (singleton==null)
			singleton=new ECPesystemFactory();
		return singleton;
	}
	...
	public CreateSimulator getCreateSimulator() throws PlinguaCoreException {
		...
		return new ECPeCreateSimulator(getModelName());
	}
