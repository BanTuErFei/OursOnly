...
public class RightHandRule extends HandRule {
	...
	public RightHandRule(OuterRuleMembrane outerMembrane,
		...
		//System.out.println("RF "+ outerMembrane);
		//System.out.println("RFM "+ multiset);
		//System.out.println("RFE "+ outerMembrane.energy);
	...
	public RightHandRule(OuterRuleMembrane outerMembrane,
		...
		super(outerMembrane, multiset);
		System.out.println("RF "+ outerMembrane);
		System.out.println("RF "+ secondOuterMembrane);
		System.out.println("RFM "+ multiset);
